...
import 'package:Molhem/screens/parent_videos_list.dart';
...
class ParentVideoCategory extends StatelessWidget {
  final String name;
  final String categoryId;
  final String image;

  const ParentVideoCategory({
    Key? key,
    required this.name,
        ...
        Navigator.of(context).push(
          PageRouteBuilder(
            pageBuilder: (context, animation, secondaryAnimation) =>
                ParentVideosList(categoryId: categoryId),
